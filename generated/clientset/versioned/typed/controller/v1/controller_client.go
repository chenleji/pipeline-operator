...
import (
	...
	"github.com/chenleji/pipeline-operator/generated/clientset/versioned/scheme"
...
// ControllerV1Client is used to interact with features provided by the controller.ljchen.net group.
type ControllerV1Client struct {
	restClient rest.Interface
}

func (c *ControllerV1Client) Pipelines(namespace string) PipelineInterface {
	return newPipelines(c, namespace)
}

func (c *ControllerV1Client) PipelineRuns(namespace string) PipelineRunInterface {
